...
# This file ONLY works for PyQt6!
try:
  from PyQt6.QtWidgets import *
  from PyQt6.QtGui import *
  from PyQt6.QtCore import *
except:
	print("ERROR: This version of the GUI only works for PyQt6. Make sure you are using PyQt6, or use the standard version of the GUI.")
	exit()
